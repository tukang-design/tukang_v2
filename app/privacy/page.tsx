  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        ...
        <li>
          Payment details (for service purchases, handled securely via payment
          gateways)
        </li>
      </ul>
      <h2 className="text-2xl font-semibold mt-8 mb-2">
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        ...
        <li>
          Contact us at{" "}
          <a
            href="mailto:hello@tukang.studio"
      ...
      <p className="mb-4 text-gray-700">
        We use trusted third-party services (Sanity, Cal.com) to deliver our
        services. Your data is handled securely and never sold.
      </p>
