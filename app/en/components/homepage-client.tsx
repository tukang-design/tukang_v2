...
import RegionSelector, { getRegionDetails } from "./region-selector";
import {
  PrimaryCTA,
  SecondaryCTA,
  TertiaryCTA,
...
export default function HomePageClient({ children }: HomePageClientProps) {
  ...
  // Package pricing based on region (V2 Recalibrated) - matching services page
      ...
      <section className="relative overflow-hidden pb-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
          <div className="text-center">
            ...
            >
              End-to-end design and development without the handoff headaches.
            </h2>
            ...
            <p
              ...
              style={{ animationDelay: animationStarted ? "1.2s" : "9999s" }}
            >
              From pixel-perfect mockups to clean, efficient code, we manage the
              entire process. This unified approach eliminates costly errors and
              ensures a superior final product, delivered on time.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              We offer clear, value-driven tiers for every stage of business
              growth. Each one is a complete, end-to-end solution handled by our
              expert team.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-olive-dark/30 rounded-2xl p-8 border border-brown/30 hover:border-brown/50 transition-all duration-300 relative z-20">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-4">
                A single, high-impact page to capture leads or launch a product.
              </p>
              <p className="text-accent font-bold text-lg mb-6">
                Starts at {regionDetails.symbol}
                {
            ...
            <div className="group bg-olive-dark/30 rounded-2xl p-8 border border-brown/30 hover:border-brown/50 transition-all duration-300 relative z-20">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-4">
                A complete, multi-page site to build trust and showcase your
                brand.
              </p>
              <p className="text-accent font-bold text-lg mb-6">
                Starts at {regionDetails.symbol}
            ...
            <div className="group bg-olive-dark/30 rounded-2xl p-8 border border-brown/30 hover:border-brown/50 transition-all duration-300 relative z-20">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-4">
                A custom solution with e-commerce, bookings, or a full CMS.
              </p>
              <p className="text-accent font-bold text-lg mb-6">Custom Quote</p>
              <TertiaryCTA
                href="/en/services#custom-solutions"
                icon={<ChevronRightIcon />}
                size="sm"
              >
                Learn More
