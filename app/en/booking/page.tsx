                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300">
                          ...
                          create a website that truly serves your business
                          needs.
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-8 max-w-4xl mx-auto">
                ...
                <div className="bg-gradient-to-br from-olive-dark/80 to-olive-dark/60 backdrop-blur-sm rounded-3xl border border-accent/20 p-8 text-center">
                  ...
                  <div className="bg-brown/10 border border-brown/20 rounded-xl p-6">
                    ...
                    <p className="text-gray-300 text-sm">
                      Once you complete the deposit payment, you'll be directed
                      to our onboarding page where you can:
                    </p>
              ...
              <div className="space-y-8 max-w-4xl mx-auto">
                <div className="bg-gradient-to-br from-olive-dark/80 to-olive-dark/60 backdrop-blur-sm rounded-3xl border border-accent/20 p-8 text-center">
                  ...
                  <p className="text-gray-300 mb-8 leading-relaxed">
                    Complex projects like e-commerce stores, booking systems,
                    and custom applications require a personalized approach.
