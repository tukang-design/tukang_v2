...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: post.title,
      description: post.excerpt,
      images: post.featuredImage ? [post.featuredImage.asset.url] : ["/og-blog.jpg"],
    },
  };
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <nav className="mb-8">
            <div className="flex items-center space-x-2 text-sm text-gray-400">
              ...
              <span>/</span>
              <Link href="/en/blog" className="hover:text-accent transition-colors">
                Blog
              </Link>
              <span>/</span>
          ...
          <header className="mb-12">
            ...
            {post.author && (
              <div className="flex items-center mt-8 pt-6 border-t border-accent/20">
                ...
                <div>
                  <p className="text-accent font-medium">By {post.author.name}</p>
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              {post.content ? (
                <div className="text-gray-300 leading-relaxed space-y-6">
                  <p>
                    This blog post content is loaded from Sanity CMS. 
                    The rich text content will be properly rendered here.
                  </p>
                  <div className="bg-olive/30 p-4 rounded-lg">
                ...
                <div className="text-gray-300 leading-relaxed space-y-6">
                  <p>
                    This blog post is available in the system but the content needs to be configured in Sanity CMS.
                  </p>
                </div>
              )}
            </div>
